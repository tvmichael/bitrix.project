			...
			<div id="footer-in">
				<div class="col-lg-2 col-md-3 col-sm-3">
					<div class="block block0">
						<div class="footer_logo"><a href="http://alexsauna.ru/"><img src="<?=SITE_TEMPLATE_PATH?>/images/logo_footer.png" alt=""/></a>
						</div>
					</div>
				</div>
			<div class="col-lg-3 col-md-3 col-sm-3">
				<div class="block block1">		
					<div class="f-contacts"><b>© 2013-2017&nbsp;&nbsp;ООО&nbsp;"Алекспулс"</b>
					</div>
					<div class="copy">
