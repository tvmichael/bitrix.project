...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid">
		...
		if ($arParams['DISPLAY_NAME'] === 'Y')
		{
			...
			<div class="row">
				<div class="col-xs-12">
					<h1 class="bx-title"  style="font-size: 15px; font-weight: bold; color: #185DA2;"><?=$name?></h1>
				</div>
			</div>
			<?
		}
						...
						<div class="product-item-detail-pay-block">
							...
							foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName)
							{
								switch ($blockName)
								{
									...
									case 'price':
										?>
										<div class="product-item-detail-info-container col-md-7 col-sm-12">
											<?
											if ($arParams['SHOW_OLD_PRICE'] === 'Y')
											{
												...
												?><div class="item_price"><div class="item_price_arhi">Цена:</div>
												<div class="product-item-detail-price-current" id="<?=$itemIds['PRICE_ID']?>"><?=$price['PRINT_RATIO_PRICE']?>
													<div class = "feedback_form" style = "margin-top: 10px;"></div>
												</div>
												...
												<img src="/bitrix/templates/bis/images/payment_button.png" alt="" style = "margin-top: 20px;">
											</div>
											<?
											if ($arParams['SHOW_OLD_PRICE'] === 'Y')
											{
									...
									case 'quantity':
										...
										{
											?>
											<div class="product-item-detail-info-container col-md-5 col-sm-12" style="<?=(!$actualItem['CAN_BUY'] ? 'display: none;' : '')?>"
								...
								if ($showDescription)
								{
									...
									<li class="product-item-detail-tab active" data-entity="tab" data-value="description">
										<a href="javascript:void(0);" class="product-item-detail-tab-link">
											<span style = "font-size: 14px; font-weight: 100;">Полное описание</span>
										</a>
									</li>
									<?
								}
																			...
																			if ($skuProperty['SHOW_MODE'] === 'PICT')
																			{
																				...
																				<li class="product-item-scu-item-color-container" title="<?=$value['NAME']?>"
																					...
																					<div class="product-item-scu-item-color-block">
																						<div class="product-item-scu-item-color-title"><?=$value['NAME']?></div>
