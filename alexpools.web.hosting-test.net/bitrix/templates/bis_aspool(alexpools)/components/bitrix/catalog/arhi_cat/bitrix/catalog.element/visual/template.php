...
<div class="bx_item_detail" id="<? echo $arItemIDs['ID']; ?>">
	...
	<div class="bx_item_container">
		<div class="bx_lt">
			<div class="bx_item_slider" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
				<div class="bx_bigimages">
					<!-- update- 2)11-01-18 1)27-11-2017 -->
					<div class="bx_bigimages_imgcontainer" data-toggle="modal" data-target="#b-modal-big-img-show" data-backdrop="false">
						...
						<img 
							...
							?>
								...
								alt="<?=$arResult["MORE_PHOTO"][0]["DESCRIPTION"];?>"
								title="<?=$arResult["MORE_PHOTO"][0]["DESCRIPTION"];?>"								
							<?
								$bxListBigImages_count = 1;
		                        $bxListBigImages = "<div class='item active'><img class='b_modal_images' src='".
	                            $arResult['MORE_PHOTO'][0]['SRC']."'></div>"; 
								//if ( $USER->IsAdmin() ) {print_r($arResult['MORE_PHOTO'][0]);}
							}
							?>
							...
							<div class="bx_slider_scroller_container">
								<div class="bx_slide">
									<ul style="width: <? echo $strWidth; ?>;" id="<? echo $arItemIDs['SLIDER_LIST']; ?>">
										...
										{
										?>
											<li style="width: <? echo $strOneWidth; ?>; padding-top: <? echo $strOneWidth; ?>;">	<a href="javascript:void(0)">
													<span  data-src="<? echo $arOnePhoto['SRC']; ?>" style="background-image:url('<? echo $arOnePhoto['SRC']; ?>');"></span>
												</a>
											</li>
										<?
											// Edit- modal window
											$bxListBigImages_count ++;
		...
		<!-- Edit- 27-11-2017  data-backdrop="false" -->
		<!-- Modal -->
        ...
        <script>
            ...
            (function(){                
                try 
                {
                    ...
                    // 2. set modal windows size
                    var minHeightModalWindow = 200;
                    $('#myCarousel_slider img').each(function(){                    	
                    	if (this.naturalHeight > minHeightModalWindow)
                    		minHeightModalWindow = this.naturalHeight;

                    	if (this.naturalHeight > window.innerHeight)
                    		minHeightModalWindow = window.innerHeight - 200;

                    });
                    $('#b-modal-big-img-show .modal-body').height(minHeightModalWindow);
                    $('#b-modal-big-img-show .carousel-inner').height(minHeightModalWindow);
                    ...
                    function setWindowsSize(event){
                        //bModalBigImgShow_Dialogwh.style.width = window.innerWidth-240 + 'px';
                        //bModalBigImgShow_Contentwh.style.height = window.innerHeight-140 + 'px';                    
                        //bModalBigImgShow_carouselInner.style.height = window.innerHeight-30 + 'px';
                        adaptiveImageSize();
                    };
