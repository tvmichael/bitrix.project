			...
			<div class="column">
				...
				<!--select name="countElements" id="selectCountElements"-->
					<?foreach ($arSortProductNumber as $arSortNumberElementId => $arSortNumberElement):?>
						<div class="element"><a<?if($arSortNumberElement["SELECTED"] != "Y"):?> href="<?=$APPLICATION->GetCurPageParam("SORT_TO=".$arSortNumberElementId, array("SORT_TO"));?>"<?endif;?> class="<?=$arSortNumberElement["NAME"]?><?if($arSortNumberElement["SELECTED"] == "Y"):?>selected<?endif;?>"><?=$arSortNumberElementId?></a></div>
					<?endforeach;?>
				<!--/select-->
				</div>
			</div>
...
<?reset($arTemplates[$_COOKIE["CATALOG_VIEW"]]);?>
			<?
	//if($USER->IsAdmin()) {echo '<pre>'; print_r($arParams["CATALOG_TEMPLATE"]); echo '</pre>';}
	//if($USER->IsAdmin()) {echo '<pre>'; print_r(key($arTemplates)); echo '</pre>';}
	if($USER->IsAdmin()) {echo '<pre>'; print_r($arSortNumberElementId); echo '</pre>';}
...
//if($USER->IsAdmin()) {echo '<pre>'; print_r(!empty($_COOKIE["CATALOG_SORT_TO"]) && $arSortProductNumber[$_COOKIE["CATALOG_SORT_TO"]]); echo '</pre>';}
if($USER->IsAdmin()) {echo '<pre>'; print_r($arSortProductNumber[$_REQUEST["SORT_TO"]]); echo '</pre>';}
