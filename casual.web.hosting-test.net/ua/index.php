...
$APPLICATION->SetTitle("Інтернет магазин Casualua");
?>
...
?>
<div class="col-xs-12 cs-filter-main-container">
	<?
	// SESSION
	...
	elseif(isset($_SESSION['BX_FILTER_DATA']) && $_SESSION['BX_FILTER_DATA']['PHP_SELF'] == $_SERVER['PHP_SELF'])
	{
		$sortPriceMetod = $_SESSION['BX_FILTER_DATA']['PRICE_SORT'];		
	}
	else 
	{
		$sortPriceMetod = 'sort';
