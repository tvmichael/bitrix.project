...
<script async src="<?=SITE_TEMPLATE_PATH?>/js/jquery.maskedinput.min.js"></script>
...
<?if($_GET['PAGEN_1']) $get_zapros_page=$_GET['PAGEN_1'];
if($_GET['lang']=='en' || $_GET['lang']=='ru' || $_GET['lang']=='ua' || $_GET['PRICE_SORT']){
	if($get_zapros_page > 1){
		echo '<link rel="canonical" href="https://'.SITE_SERVER_NAME.$curPage.'?PAGEN_1='.$get_zapros_page.'">';
	}else{
...
<script>
  ...
  s.parentNode.insertBefore(t,s)}(window, document,'script',
  'https://connect.facebook.net/en_US/fbevents.js');
  fbq('init', '139915703287720');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" style="display:none"
  src="https://www.facebook.com/tr?id=139915703287720&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
