...
(function () {
    ...
    BX.Sale.OrderAjaxComponent = {
        ...
        hideDeliveryBranch: function(){
            var hideBlock =  $('#bx-soa-delivery .bx-soa-pp-company');
            if ($(hideBlock[1]).hasClass("bx-selected") )                
            {
                $('#bx-soa-region').hide();
                $("[data-property-id-row='55']").hide();
            } else {
                $('#bx-soa-region').show();
                $("[data-property-id-row='55']").show();
            }
        },
        ...
        startLoader: function () {
            ...
            return setTimeout(BX.delegate(function () {
        ...
        createPaySystemItem: function (item) {
            ...
            if (this.params.SHOW_PAY_SYSTEM_LIST_NAMES == 'Y') {
                ...
                title = BX.create('DIV', {
                    ...
                    html: "<strong>" + item.NAME + "</strong><br><br>" + item.DESCRIPTION,
                });
            }
