...
<div id="basket_items_list">
	<div class="bx_ordercart_order_table_container col-sm-12 col-md-9">
							...
							?>
								<td class="custom">
									...
									?>
                                        ...
                                        <div class="bonus bonus_item_cart" id="bonus_sum_<?=$arItem["ID"]?>">
	...
	<div class="bx_ordercart_order_pay col-sm-12 col-md-3">
		<!---------------->
		<?
		if ($arResult['allSum'] < 5000) 
		{
			$arNeed = 5000 - $arResult['allSum'];
			$arPercent = $arResult['allSum']*100/5000;
			$messageConteiner = 'block';
		}
		else $messageConteiner = 'none';
		?>
			<div id="progress-bar-message-container" style="display:<?= $messageConteiner;?>;">
				<div class="shipping-threshold_title shipping-threshold_title">
				    <span class="shipping-threshold_amount">Добавьте еще товара на 
				    	<span class="shipping-threshold-amount-need"><?=$arNeed ?></span> руб.
				    </span>
				    и получите бесплатную доставку.
				</div>
				<div class="progress-bar-container">
				    <span class="progress-bar" style="width:<?=$arPercent?>%"></span>
				</div>
			</div>
		<!---------------->

		<div class="bx_ordercart_order_pay col-lg-12 col-md-12 col-sm-12 col-xs-12" id="coupons_block">
		<?
...
?>
		...
		<div class="bx_ordercart_order_pay col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
if($arBonus["ALL_BONUS"] > 0) {?>
    <div class="bonus" id="bonus_sum_<?=$arItem["ID"]?>_2">
...
<? }?></div>
		...
		<div style="clear:both;"></div>
		<div class="bx_ordercart_order_pay_center col-lg-12 col-md-12 col-sm-12 col-xs-12">
