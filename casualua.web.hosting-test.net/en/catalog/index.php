...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_MAIN_BLOCK_PROPERTY_CODE" => array(
			0 => "fabric_structure_en",
		),
		"DETAIL_META_DESCRIPTION" => "descripion_en",
		"DETAIL_META_KEYWORDS" => "keywords_en",
		...
		"GIFTS_MAIN_PRODUCT_DETAIL_BLOCK_TITLE" => "Choose one of the items to receive a gift",
		...
		"LINK_IBLOCK_TYPE" => "",
		"LINK_PROPERTY_SID" => "",
		"LIST_BROWSER_TITLE" => "UF_TITLE_EN",
		"LIST_ENLARGE_PRODUCT" => "STRICT",
		"LIST_META_DESCRIPTION" => "UF_DESCRIPTION_EN",
		"LIST_META_KEYWORDS" => "UF_KEYWORDS_EN",
		...
		"LOAD_ON_SCROLL" => "N",
		"MAIN_TITLE" => "Availability in stock",
