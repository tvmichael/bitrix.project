			...
			<div class="row <?=$rowData['CLASS']?>" data-entity="items-row">
				...
				switch ($rowData['VARIANT'])
				{
					...
					case 2:
						?>
						<div class="col-xs-12 product-item-small-card">
							<!-- update- 18-02-01   catalog.section\.default\template.* -->
							<div class="row">
								<?
								foreach ($rowItems as $item)
								{
...
//$messageInfoText = '<p>'.GetMessage("CT_BCE_CATALOG_ADD_TO_BASKET_OK_AGREEMENT_5_PERSENT").'<span style="color:red;">'.GetMessage("CT_BCE_CATALOG_ADD_TO_BASKET_OK_5_PERSENT").'<span></p><p>'.GetMessage("CT_BCE_CATALOG_ADD_TO_BASKET_OK_AGREEMENT").'</p>';
...
<script>
	BX.message({
		...
		SITE_ID: '<?=SITE_ID?>',
		//MESSAGE_BASKET_INFO_TEXT: '<?=$messageInfoText;?>',
		//MESSAGE_BASKET_INFO_TEXT:'<?=CUtil::PhpToJSObject($messageInfoText, false, true)?>',
		MESSAGE_BASKET_PRODUCT_RECOMMENDATION: '<?=GetMessage("MESSAGE_BASKET_PRODUCT_RECOMMENDATION");?>',
		MESSAGE_ADD_TO_BASKET_OK: '<?=GetMessage("ADD_TO_BASKET_OK");?>'
	});
