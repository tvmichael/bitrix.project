...
<div style="width: 100%;">
	...
	<?else:?>	
		...
		<table style="width: 100%;">
			<thead>
				<tr>
					<th style="background-color: #EAEAEA; padding: 5px; width: 60%;" colspan="2">
						<?=GetMessage("SPOD_information_bout_payer")?>
					</th>
					<th style="width: 2%;"></th>
					<th style="background-color: #EAEAEA; padding: 5px; width: 38%;">					
			...
			<?if($arParams["SHOW_ORDER_BASKET"]=='Y'):?>
				<h3 style="font-size: 16px; text-align: center"><?=GetMessage('SPOD_ORDER_BASKET')?></h3>
			<?endif?>
		<?endif?>
		...
		<!-- ORDER BASKET -->
		<?if($arParams["SHOW_ORDER_BASKET"]=='Y'):?>
		<table style="width: 100%;" class="bx-order-list-table">
			<thead>
				<tr style="background-color: #EAEAEA;" class="bx-order-header">			
					<th></th>
					<?
					foreach ($arParams["CUSTOM_SELECT_PROPS"] as $headerId):						
						...
						?><th style="padding: 5px;" class="cs-spod-order" <?=$colspan?>><?=$headerName?></th><?
					endforeach;
					?>
				</tr>
			</thead>
		...
		<table style="width: 100%; margin: 10px 0px; border-top: 25px solid #e8e8e8;">
			<tbody>
				<?/* ///// WEIGHT ?>
				...
				<? ///// PRICE SUM ?>
				<tr>
					<td style="text-align: right; padding: 3px 0px;"><?=GetMessage('SPOD_PRODUCT_SUM')?>:</td>
					<td style="text-align: right;"><b><?=$arResult['PRODUCT_SUM_FORMATED']?></b></td>
				</tr>

				<? ///// DELIVERY PRICE: print even equals 2 zero ?>
				<?if(strlen($arResult["PRICE_DELIVERY_FORMATED"])):?>
					<tr>
						<td style="text-align: right; padding: 3px 0px;"><?=GetMessage('SPOD_DELIVERY')?>:</td>
						<td style="text-align: right;"><?=$arResult["PRICE_DELIVERY_FORMATED"]?></td>
					</tr>
				<?endif?>
				...
				<tr>
					<td style="text-align: right; padding: 3px 0px;"><?=GetMessage('SPOD_SUMMARY')?>:</td>
					<td style="text-align: right;"><?=$arResult["PRICE_FORMATED"]?></td>
				</tr>
			</tbody>
		</table>
		<?endif?>
