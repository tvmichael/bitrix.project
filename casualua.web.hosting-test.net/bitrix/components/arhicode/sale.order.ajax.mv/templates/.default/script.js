console.log('BX.saleOrderAjax /sale.order.ajax.mv/.default/script.js');
...
BX.saleOrderAjax = { // bad solution, actually, a singleton at the page
	...
	{
		console.log('...initDeferredControl');
	...
	{
		console.log('...getAltLocPropByRealLocProp');		
	...
	{
		console.log('...getPreviousAdapterSelectedNode');	
