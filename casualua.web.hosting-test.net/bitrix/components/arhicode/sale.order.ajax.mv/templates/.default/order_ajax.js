...
(function() {
	...
	console.log('BX.Sale.OrderAjaxComponent  /sale.order.ajax.mv/.default/order_ajax.js');
	...
	BX.Sale.OrderAjaxComponent = {
		...
		clickOrderSaveAction: function(event)
		{
			...
			{				
				...
				{
					console.log('--clickOrderSaveAction -2');
					BX.onCustomEvent('bx-soa-order-save', []);
				}
				else
				{
					console.log('--clickOrderSaveAction -3');
					this.doSaveAction();
				}
			}
		...
		{
			console.log('--getBlockFooter -buttons');
			...
			{
				console.log('--getBlockFooter -buttons 1');
			...
			if (!isLastNode)
			{
				console.log('--getBlockFooter -buttons 2');
		...
		{
			console.log('--editActiveRegionBlock');
