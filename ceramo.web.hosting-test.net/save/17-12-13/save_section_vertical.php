			...
			<div class="column">
				...
				<div class="sortFields" id="selectSortParams">
					...
					<ul class="dropdown-menu">
						...
						<li class="element">
							<a<?if($arSortField["SELECTED"] != "Y"):?> href="<?=$APPLICATION->GetCurPageParam("SORT_FIELD=".$arSortFieldCode, array("SORT_FIELD"));?>"<?endif;?> class="<?=$arSortField["NAME"]?><?if($arSortField["SELECTED"] == "Y"):?>selected<?endif;?>"><?=$arSortField["NAME"]?></a>
						</li>
						<?endforeach;?>
					</ul>
					</div>
