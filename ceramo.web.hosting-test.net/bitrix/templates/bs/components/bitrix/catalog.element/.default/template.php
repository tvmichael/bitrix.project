    ...
    <div class="detail1 row">
        ...
        <div class="pict_d1 col-md-8 col-sm-7 col-xs-12"> <?//slaider з картинками?>
				...
				<div class="product-item-detail-slider-container" id="<?=$itemIds['BIG_SLIDER_ID']?>">
					...
					<div class=" col-sm-9 col-sm-push-3 col-xs-12 product-item-detail-slider-block
						...
						<div>
							<?//закоментовано 13.12.17//  =(!$arResult['LABEL'] ? 'style="display: none;"' : '' )?>
							<?
					...
					if ($showSliderControls)
					{
						if ($haveOffers)
						{
							foreach ($arResult['OFFERS'] as $keyOffer => $offer)
							{
								...
								?>
								<div class="col-sm-3 col-sm-pull-9 col-xs-12  product-item-detail-slider-controls-block" id="<?=$itemIds['SLIDER_CONT_OF_ID'].$offer['ID']?>" style="display: <?=$strVisible?>;">
									<?
									foreach ($offer['MORE_PHOTO'] as $keyPhoto => $photo)
									{
										?>
										<div class="col-sm-12 col-xs-4 product-item-detail-slider-controls-image<?=($keyPhoto == 0 ? ' active' : '')?>"
						...
						{
							?>
							<div class="col-sm-3 col-sm-pull-9 col-xs-12 product-item-detail-slider-controls-block" id="<?=$itemIds['SLIDER_CONT_ID']?>">
								<?
								if (!empty($actualItem['MORE_PHOTO']))
								{
									foreach ($actualItem['MORE_PHOTO'] as $key => $photo)
									{
										?>
										<div class="col-sm-12 col-xs-4 product-item-detail-slider-controls-image<?=($key == 0 ? ' active' : '')?>"
		...
		<?if (!empty($arResult['DISPLAY_PROPERTIES']) || $arResult['SHOW_OFFERS_PROPS'])
	         ...
	         <?//end block .proper?>
							...
							foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName)
							{
								switch ($blockName)
								{
									case 'rating':
										...
										{
											?>
											<div class="zirochki_d1 col-xs-6 col-sm-12 product-item-detail-info-container">
												<?
									...
									case 'price':
										...
										<div class="price_d1 col-xs-6 col-sm-12 product-item-detail-info-container">
											<?
									...
									case 'priceRanges':
										if ($arParams['USE_PRICE_COUNT'])
										{
											...
											?>
											<div class="priceRanges_d1 col-xs-6 col-sm-12 product-item-detail-info-container"
									...
									case 'quantityLimit':
										if ($arParams['SHOW_MAX_QUANTITY'] !== 'N')
										{
											...
											{
												?>
												<div class="quantityLimit_d1 col-xs-6 col-sm-12 product-item-detail-info-container" id="<?=$itemIds['QUANTITY_LIMIT']?>" style="display: none;">
													<div class="product-item-detail-info-container-title">
											...
											else
											{
												...
												{
													?>
													<div class="quantityLimit_d1 col-xs-6 col-sm-12 product-item-detail-info-container" id="<?=$itemIds['QUANTITY_LIMIT']?>">
														<div class="product-item-detail-info-container-title">
															<?=$arParams['MESS_SHOW_MAX_QUANTITY']?>:
									...
									case 'quantity':
										...
										{
											?>
											<div class="kilk_d1 col-xs-6 col-sm-12 product-item-detail-info-container" style="<?=(!$actualItem['CAN_BUY'] ? 'display: none;' : '')?>"
									...
									case 'buttons':
										?>
										<div data-entity="main-button-container" class="button_d1 col-xs-6 col-sm-12">
							...
							{
								?>
								<div class="compare_d1 col-xs-6 col-sm-12">
								...
								if ($arResult['PROPERTIES']['description_detail']['VALUE'] != ''){
									$APPLICATION->IncludeComponent(
										...
										Array(
											...
											"EDIT_TEMPLATE" => "",
											"PATH" => "/upload/catalog_detail/".$arResult['PROPERTIES']['description_detail']['VALUE']
										)
									);
								}
								else 
...
<?foreach ($arResult['PROPERTIES']['komplektujuchi']['VALUE'] as $kompl)
	...
	<?}?>
        ...
        <!--div class="shozi col-md-8 col-sm-12 col-xs-12">
            <h4>Схожі товари</h4>
            <div class="col-xs-12 col-sm-6 col-md-3"><img src="http://fakeimg.pl/200x150/00CED1/FFF/?text=img+placeholder"></div>
            <div class="col-xs-12 col-sm-6 col-md-3"><img src="http://fakeimg.pl/200x150/00CED1/FFF/?text=img+placeholder"></div>
            <div class="col-xs-12 col-sm-6 col-md-3"><img src="http://fakeimg.pl/200x150/00CED1/FFF/?text=img+placeholder"></div>
            <div class="col-xs-12 col-sm-6 col-md-3"><img src="http://fakeimg.pl/200x150/00CED1/FFF/?text=img+placeholder"></div>
        </div-->
	...
	<!--Top tabs-->
	<div class="product-item-detail-tabs-container-fixed hidden-xs hidden-sm hidden-md hidden-lg" id="<?=$itemIds['TABS_PANEL_ID']?>">
		<ul class="product-item-detail-tabs-list">
			<?
			if ($showDescription)
			{
