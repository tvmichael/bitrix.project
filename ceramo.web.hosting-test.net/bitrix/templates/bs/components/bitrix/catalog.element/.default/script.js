(function(window){
	...
	window.JCCatalogElement = function(arParams)
	{
		...
		//console.log('catalog.element:JCCatalogElement');
		//console.log(this);
	};
	...
	window.JCCatalogElement.prototype = {
		...
		initConfig: function()
		{
			...
			if(this.params.CONFIG.BADGE_PARAM_TIMER){
				this.config.bageParamTimer = this.params.CONFIG.BADGE_PARAM_TIMER;
				this.initCountdownTimer(this.visual.BADGE_TIMER_ID, this.config.bageParamTimer.format);
			}
		},
