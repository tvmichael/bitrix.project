		...
		<a class="product-item-image-wrapper" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
			...
			if ($item['LABEL'])
			{
				?>			
					...
					{
						foreach ($item['LABEL_ARRAY_VALUE'] as $code => $value) $labelvalue = "true"; 
						{
			...
			?>
			<div class="product-item-gift" style="display:<?=(count($giftProductIds)>0?'block':'none');?>;">
